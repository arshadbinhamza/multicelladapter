...
import com.abh.sample.network.RetrofitInstance
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class MovieViewModel : ViewModel() {
	private var movieLiveData = MutableLiveData<List<ResultItems>>()
fun getPopularMovies() {
	...
	fun observeMovieLiveData() : LiveData<List<ResultItems>> {
